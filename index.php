...
?>
    ...
    <header class="container">
        <span class="intro__text">
            ...
            <p class="intro__text--paragraph">We put the tools, you do your thing. Come on in and check why <a href="">we do what we do.</a></p>
            <svg class= "fl-header" width="262" height="334" viewBox="0 0 262 334" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<section class="CTA CTA__1">
    ...
    <span class="CTA__1--text">
        <h2 class="color__light">Only yours, actually.</h2>
        <p class="p-small color__white">A unique and fully interactive shirt editor where you can play with our massive set of templates and fabrics. Jump in, sit back and let yourself go.</p>
        <a class="button" href="/editor.html" target=”_blank”>Make your own</a>
    </span>
</section>

    <!--horizontal scrol: https://medium.com/@lucas.eckman/ditch-the-carousel-creating-a-horizontal-scroll-effect-7a36c0f1c456-->

            <!--CTA-2-->
<section>
    <h2>Or just steal someone else's</h2>
    <div id="root"></div>
</section>
...
<section class="blog">
    ...
    <script src="/js/editor copy.js"></script>
</body>
</html>